...
const cognitoRegion = process.env.COGNITO_REGION || process.env.AWS_REGION || 'ap-south-1';
const client = jwksClient({
  jwksUri: `https://cognito-idp.${cognitoRegion}.amazonaws.com/${process.env.COGNITO_USER_POOL_ID}/.well-known/jwks.json`,
  cache: true,
